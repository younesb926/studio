  ...
  return (
    <div className="min-h-screen flex flex-col bg-secondary">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8 text-center">
        <div className="max-w-md bg-background p-12 rounded-3xl shadow-xl border">
          ...
          <Link href="/">
            <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground h-12 text-lg font-black gap-2">
